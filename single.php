...
<main class="ea-main-page">
  <section class="proyect-section-content">
    ...
    <?php if (get_field('imagen_del_proyecto')): ?>
      <img class="proyect-section-content__image" src="<?php the_field('imagen_del_proyecto'); ?>" alt="<?php the_title(); ?>" />
    <?php endif; ?>
    ...
    <div class="proyect-section-content__links">
      <a class="global-button" href="<?php echo esc_attr(get_field('link_a_demo_del_proyecto')); ?>"><?php echo esc_html('Ver Demo del proyecto'); ?></a>
      <a
