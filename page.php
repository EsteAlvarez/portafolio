...
<main class="ea-main-page">
    ...
    <section class="global-sections-margin">
        ...
        <div class="ea-skills-container">
            <div>
                <h3><?php echo esc_html(get_field('lenguajes')); ?></h3>
                <div class="ea-skills-container__list">
                    <?php the_field('lenguajes_dominados'); ?>
                </div>
            </div>
            <div>
                <h3><?php echo esc_html(get_field('frameworks')); ?></h3>
                <div class="ea-skills-container__list">
                    <?php the_field('frameworks_dominados'); ?>
                </div>
            </div>
            <div>
                <h3><?php echo esc_html(get_field('cms')); ?></h3>
                <div class="ea-skills-container__list">
                    <?php the_field('cms_dominados'); ?>
                </div>
            </div>
            <div>
                <h3><?php echo esc_html(get_field('diseno')); ?></h3>
                <div class="ea-skills-container__list">
                    <?php the_field('herramientas_de_diseno_dominadas'); ?>
                </div>
            </div>
            <div>
                <h3><?php echo esc_html(get_field('herramientas')); ?></h3>
                <div class="ea-skills-container__list">
    ...
    <section class="global-sections-margin">
        <div class="ea-title-experience-cotainer">
            ...
            <?php if (get_field('curriculum')): ?>
                <a class="global-button" href="<?php the_field('curriculum'); ?>" target="_blank"><?php echo esc_html('Ver Currículum'); ?></a>
            <?php endif; ?>
        </div>
    ...
    <section class="global-sections-margin">
        ...
        <div class="swiper projects-swiper">
            <div class="swiper-wrapper">
                <?php include get_template_directory() . '/assets/modulos/loop-proyectos.php'; ?>
            </div>
        </div>
    </section>
